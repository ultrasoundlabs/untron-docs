...
- `setProvider` is used to set the liquidity provider details. You might need this to either provide liquidity for Untron, or implement intron (reversed) swaps to USDT Tron. Unlike `createOrder`, this function does not require collateral.
